...
class Database extends Config
{
    ...
    public array $default = [
        'DSN' => '',
        'hostname' => 'aws-0-us-east-1.pooler.supabase.com', // Supabase Transaction Pooler
        'username' => 'postgres.cmdkjvwqyyrmariggmv',
        'password' => '', // Will be set via env or user input
        'database' => 'postgres',
        'DBDriver' => 'Postgre',
        'DBPrefix' => '',
        'pConnect' => false,
